...
object Build extends Build {
  ...
  val root = Project(id = moduleName, base = file(".")).enablePlugins(GatlingPlugin)
    ...
    .settings(libraryDependencies ++= {
      ...
      Seq(
        "org.elasticmq" %% "elasticmq-core" % `elasticmq-version` excludeAll ExclusionRule(organization = "io.spray") exclude ("com.typesafe.akka", "akka-stream-experimental"),
        "org.elasticmq" %% "elasticmq-rest-sqs" % `elasticmq-version` excludeAll ExclusionRule(organization = "io.spray") exclude ("com.typesafe.akka", "akka-stream-experimental"),
